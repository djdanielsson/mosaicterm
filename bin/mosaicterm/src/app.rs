...
use mosaicterm::terminal::{Terminal, TerminalFactory, ShellType as SessionShellType};
...
impl MosaicTermApp {
    ...
    pub async fn initialize_terminal(&mut self) -> Result<()> {
        ...
        let shell_type = match self.runtime_config.config().terminal.shell_type {
            mosaicterm::config::shell::ShellType::Bash => ModelShellType::Bash,
            mosaicterm::config::shell::ShellType::Zsh => ModelShellType::Zsh,
            mosaicterm::config::shell::ShellType::Fish => ModelShellType::Fish,
            // Map other shell types to supported ones or use Other variant
            mosaicterm::config::shell::ShellType::Ksh |
            mosaicterm::config::shell::ShellType::Csh |
            mosaicterm::config::shell::ShellType::Tcsh |
            mosaicterm::config::shell::ShellType::Dash |
            mosaicterm::config::shell::ShellType::PowerShell |
            mosaicterm::config::shell::ShellType::Cmd => ModelShellType::Bash, // Default to bash
            mosaicterm::config::shell::ShellType::Other => ModelShellType::Bash, // Default to bash for unknown shells
        };
