...
"#;
    ...
    fn test_current_shell_config() {
        ...
        assert_eq!(
            manager.current_shell_config().unwrap().shell_type,
            ShellType::Bash
        );
    }
    ...
    fn test_environment_variables() {
        ...
        assert_eq!(
            manager.environment().get("TEST_VAR"),
...
"#;
        ...
        manager
            .parse_fish_config(config_content, &mut environment)
            .unwrap();
...
"#;
        ...
        manager
            .parse_generic_config(config_content, &mut environment)
            .unwrap();
