                        ...
                        match code {
                            ...
                            36 => {
                                *current_color = self
                                    ...
                                    .get(&AnsiColor::Cyan)
                                    .copied()
                                    .unwrap_or(egui::Color32::from_rgb(0, 255, 255))
                            }
                            37 => {
                                *current_color = self
                                    .color_scheme
                            ...
                            93 => {
                                *current_color = self
                                    ...
                                    .copied()
                                    .unwrap_or(egui::Color32::LIGHT_YELLOW)
                            }
                            94 => {
                                *current_color = self
                                    .color_scheme
                            ...
                            95 => {
                                *current_color = self
                                    ...
                                    .copied()
                                    .unwrap_or(egui::Color32::from_rgb(255, 100, 255))
                            }
                            96 => {
                                *current_color = self
                                    .color_scheme
                                    ...
                                    .copied()
                                    .unwrap_or(egui::Color32::from_rgb(100, 255, 255))
                            }
                            97 => {
                                *current_color = self
                                    .color_scheme
