...
pub struct CommandContext {
    ...
    shell_type: crate::models::terminal_session::ShellType,
}

impl CommandContext {
    /// Create a new command context
    pub fn new(working_directory: PathBuf, shell_type: crate::models::terminal_session::ShellType) -> Self {
        Self {
            working_directory,
    ...
    pub fn is_complete_command(&self, input: &str) -> bool {
        ...
        match self.shell_type {
            crate::models::terminal_session::ShellType::Bash | crate::models::terminal_session::ShellType::Zsh => {
            ...
            crate::models::terminal_session::ShellType::Fish => {
