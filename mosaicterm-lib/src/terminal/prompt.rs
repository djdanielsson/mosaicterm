...
impl PromptDetector {
    ...
    pub fn new() -> Self {
        let mut detector = Self {
            ...
            current_shell: ShellType::Unknown,
    ...
    pub fn is_prompt(&mut self, line: &OutputLine) -> bool {
        ...
        for pattern in &self.prompt_patterns {
            if pattern.pattern.is_match(&line.text) {
                ...
                if self.current_shell == ShellType::Unknown {
...
mod tests {
    ...
    fn test_prompt_detector_creation() {
        ...
        assert_eq!(detector.current_shell(), ShellType::Unknown);
    }
    ...
    fn test_shell_type_from_string() {
        ...
        assert_eq!(PromptDetector::shell_type_from_string("unknown"), ShellType::Unknown);
    }
    ...
    fn test_utils_shell_type_name() {
        ...
        assert_eq!(utils::shell_type_name(ShellType::Unknown), "unknown");
    }
